...
export const ENGLISH_VOCAB = [
  { en: "living", es: "ser vivo", type: "living" },
  { en: "non-living", es: "materia inerte", type: "living" },
  { en: "river", es: "río", type: "nature" },
  { en: "mountain", es: "montaña", type: "nature" },
  { en: "lake", es: "lago", type: "nature" },
  { en: "forest", es: "bosque", type: "nature" },
  { en: "house", es: "casa", type: "human" },
  { en: "bridge", es: "puente", type: "human" },
  { en: "road", es: "carretera", type: "human" },
  { en: "lighthouse", es: "faro", type: "human" },
  { en: "litter", es: "basura", type: "pollution" },
  { en: "clean", es: "limpio / limpiar", type: "pollution" },
  { en: "water pollution", es: "contaminación del agua", type: "pollution" },
  { en: "air pollution", es: "contaminación del aire", type: "pollution" },
  { en: "noise pollution", es: "contaminación acústica", type: "pollution" },
  { en: "ground pollution", es: "contaminación del suelo", type: "pollution" },
  { en: "summer", es: "verano", type: "season" },
  { en: "spring", es: "primavera", type: "season" },
  { en: "autumn", es: "otoño", type: "season" },
  { en: "winter", es: "invierno", type: "season" },
];
